...
<body>
  ...
  <nav class="navbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a href="#" class="nav-link">
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <g>
              <path class="fa-secondary" d="M239,84c4.5-3.8,5.2-10.5,1.4-15c-2.4-2.9-6.1-4.3-9.7-3.8C128.2,82.8,53.9,172.5,55.7,276.4
              ...
              <path class="fa-secondary" d="M458.4,242.8c-10.5-76.6-62.3-141.2-134.7-168.3c-3.6-1.3-7.6-0.6-10.6,1.9c-19.7,17.1-38.1,35.4-55.3,55
            ...
            <path class="fa-primary" d="M399.5,10.3c-35-25.3-101.7-3.3-174.1,57.2C188,99,154.7,135,126.3,174.7c-27.6,37.9-50.5,79-68,122.5
      ...
      <li class="nav-item">
        <a href="#" class="nav-link">
          <svg fill="currenColor" aria-hidden="true" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
            ...
            <g>
              <g>
                <path class="st0"
                  ...
                  class="fa-secondary" />
                <path class="st0" d="M38.3,25.5c-1.8-0.8-3.6-1.4-5.6-1.1c-2.6,0.3-5.2,1.5-7.9,1.1c-1.7-0.2-4.5-2.1-6.1-0.8
      ...
      <li class="nav-item">
        <a href="#" class="nav-link">
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <path d="M256,320c-35.3,0-64-28.7-64-64s28.7-64,64-64s64,28.7,64,64S291.3,320,256,320z M256,224c-17.6,0-32,14.4-32,32
	                s14.4,32,32,32s32-14.4,32-32S273.6,224,256,224z" />
            <path d="M64,320c-35.3,0-64-28.7-64-64s28.7-64,64-64s64,28.7,64,64S99.3,320,64,320z M64,224c-17.6,0-32,14.4-32,32s14.4,32,32,32
	                s32-14.4,32-32S81.6,224,64,224z" />
            <path d="M448,320c-35.3,0-64-28.7-64-64s28.7-64,64-64s64,28.7,64,64S483.3,320,448,320z M448,224c-17.6,0-32,14.4-32,32
