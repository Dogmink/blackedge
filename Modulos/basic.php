            ...
            <g>
              <g>
                <path fill="currentColor"
                  ...
                  class="fa-secondary" />
                <path fill="currentColor" d="M38.3,25.5c-1.8-0.8-3.6-1.4-5.6-1.1c-2.6,0.3-5.2,1.5-7.9,1.1c-1.7-0.2-4.5-2.1-6.1-0.8
      ...
      <li class="nav-item">
        <a href="#" class="nav-link">
          <svg aria-hidden="true" focusable="false" data-prefix="fad" role="img" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <path fill="currentColor" class="fa-primary" d="M256,320c-35.3,0-64-28.7-64-64s28.7-64,64-64s64,28.7,64,64S291.3,320,256,320z M256,224c-17.6,0-32,14.4-32,32
	                s14.4,32,32,32s32-14.4,32-32S273.6,224,256,224z" />
            <path fill="currentColor" class="fa-primary" d="M64,320c-35.3,0-64-28.7-64-64s28.7-64,64-64s64,28.7,64,64S99.3,320,64,320z M64,224c-17.6,0-32,14.4-32,32s14.4,32,32,32
