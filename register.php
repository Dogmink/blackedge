...
<body>
  ...
  <div class="contenido-alert-active">
    <p style=" color: var(--hovercolor1); font-size: 18px; text-align: center;"><b>Valida tu email con el mensaje que se
        envió a tu correo, si no lo haces tu cuenta se eliminará en 30 días.</b></p>
  </div>
  <?php
      }
    }
      ...
      <div class="col8 margin-login">
        <div class="content-login">
          ...
          <form id="formulario" class="form-login">
            ...
            <p class="register-text">¿Aún no tienes cuenta? <input id="linkRegister" class="register-text-link" value="Haz click aquí"></p>
            </p>
          </form>
        </div>
      </div>
