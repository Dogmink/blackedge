                    ...
                    <select class="input-panel" name="cat_id" requiered>
                      ...
                      <?php
                                ...
                                for($x =0; $x < $cantidad; $x++){
                                  ...
                                  $item = $info_cat[$x];
                                  ?>
                      <option class="form-selectcat" value="<?php print $item['id'] ?>"><?php print $item['name_cat'] ?>
                      </option>
                      <?php
                                    }
                                  }
                  ...
                  <div class="form-input">
                    ...
                    <select class="input-panel" name="size_id" requiered>
                      ...
                      <?php
                                  ...
                                  $cantidadSize = count($info_size);
                                  if($cantidad > 0){
                                    $c=0;
                                  for($x =0; $x < $cantidadSize; $x++){
                                    $c++;
                                    $itemSize = $info_size[$x];
                                    ?>
                      <option class="form-selectcat" value="<?php print $itemSize['id'] ?>">
                        <?php print $itemSize['name_size'] ?></option>
                      <?php
                                      }
                                    }
                                    ?>
