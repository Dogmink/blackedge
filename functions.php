      ...
      <div class="col3">
        ...
        <div class="desc-product_shop">
          ...
          <svg aria-hidden="true" focusable="false" data-prefix="fad" role="img" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <g>
            	<g>
            		<path class="fa-primary" fill="currentColor" d="M509.9,89.6c-2.1-2.1-4.3-4.3-8.5-4.3H96L85.3,29.9c0-4.3-6.4-8.5-10.7-8.5h-64C4.3,21.3,0,25.6,0,32s4.3,10.7,10.7,10.7
            ...
            <g>
            	<g>
            		<path class="fa-primary" fill="currentColor" d="M394.7,384c-29.9,0-53.3,23.5-53.3,53.3c0,29.9,23.5,53.3,53.3,53.3c29.9,0,53.3-23.5,53.3-53.3S424.5,384,394.7,384z
