  ...
  <div class="contenido-userconfig">
    ...
    <form id="fUserconfig">
      <div class="row-userconfig">
        ...
        <div class="col6">
          <input class="input-userconfig-readonly" id="fPassword" type="password" name="password" value=""
            readonly="readonly">
        </div>
      </div>
      <div class="separator"></div>
      <div class="row-userconfig">
        <div class="col12">
          <p class="btn-edit-userconfig" id="resendActive" onclick="resend();">Validar Correo Electronico</p>
        </div>
      </div>
      <div class="separator"></div>
      <div class="row-userconfig">
      ...
      <div class="row-userconfig">
        <div class="col3">
          <input class="input-userconfig-readonly" id="fNombres" type="text" name="nombres" value=""
            readonly="readonly">
        </div>
        <div class="col3">
          <input class="input-userconfig-readonly" id="fApellidos" type="text" name="apellidos" value=""
            readonly="readonly">
        </div>
        <div class="col3">
          <input class="input-userconfig-readonly" id="fDNI" type="number" name="dni" pattern=".{8,8}" maxlength="8"
            value="" readonly="readonly">
        </div>
        <div class="col3">
          <input class="input-userconfig-readonly" id=fTelf type="number" name="telf" pattern=".{8,9}" maxlength="9"
            value="" readonly="readonly">
        </div>
      </div>
      <div class="separator"></div>
